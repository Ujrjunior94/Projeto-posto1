...
export default function DashboardOverview({ appState, onNavigate, onUpdatePreferences }: DashboardOverviewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 1. CARD HERO (DESTAQUE DO DIA) */}
      <div className="bg-[#0A192F] text-white rounded-2xl p-6 sm:p-8 shadow-xl space-y-6 border border-slate-800 relative overflow-hidden">
        
        {/* Glow de fundo */}
        <div className="absolute -top-24 -right-24 w-72 h-72 bg-[#00B880]/15 rounded-full blur-3xl pointer-events-none" />

        {/* Header do Card: Linha de Badges */}
        <div className="flex flex-wrap items-center justify-between gap-3 relative z-10">
          <div className="flex flex-wrap items-center gap-2">
            {/* Badge Tipo */}
            <span className="bg-[#00B880] text-white px-3 py-1 rounded-full text-[10px] font-black tracking-wider uppercase shadow-xs flex items-center gap-1.5">
              <Sparkles className="h-3 w-3" />
              DESTAQUE OPERACIONAL DO DIA
            </span>

            {/* Badge Tema */}
            <span className="border border-[#EAB308]/60 text-[#EAB308] bg-[#EAB308]/10 px-3 py-1 rounded-full text-[10px] font-bold flex items-center gap-1.5">
              Tema: Gestão Operacional, LMC & Segurança ANP
            </span>
          </div>
        ...
        <div className="flex items-center gap-1 bg-slate-900/80 p-1 rounded-xl w-fit border border-slate-800/80 relative z-10">
          {(["ARA", "NVI", "KJV"] as const).map((mode) => (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-black transition cursor-pointer ${
                heroTab === mode
                  ? "bg-[#00B880] text-white shadow-xs"
        ...
        <div className="relative z-10 space-y-2 my-2">
          <blockquote className="text-base sm:text-xl font-medium text-white italic leading-relaxed font-sans border-l-4 border-[#00B880] pl-4 sm:pl-6">
            "{currentQuote}"
          </blockquote>
        </div>
        ...
        <div className="pt-4 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4 relative z-10">
          ...
          <div className="text-xs text-slate-300 font-bold">
            <span className="text-[#00B880]">Meu Posto ERP</span> • Diretrizes ANP nº 816/2020
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="p-2 bg-slate-800/80 hover:bg-slate-700 text-slate-300 hover:text-white rounded-xl transition cursor-pointer relative"
              title="Copiar instrução"
            >
              {copiedQuote ? <Check className="h-4 w-4 text-[#00B880]" /> : <Copy className="h-4 w-4" />}
            </button>
            ...
            <button
              ...
              className={`p-2 rounded-xl transition cursor-pointer ${
                isFavorite
                  ? "bg-[#00B880]/20 text-[#00B880] border border-[#00B880]/40"
                  : "bg-slate-800/80 text-slate-300 hover:text-white"
              }`}
              title="Salvar nos Favoritos"
            >
              <Heart className={`h-4 w-4 ${isFavorite ? "fill-[#00B880]" : ""}`} />
            </button>
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-1.5 bg-slate-800/80 hover:bg-slate-700 text-slate-200 text-xs font-bold rounded-xl flex items-center gap-1.5 transition cursor-pointer"
              >
                <span>Reflexão</span>
              ...
              {showReflection && (
                <div className="absolute right-0 mt-2 w-64 bg-slate-900 border border-slate-700 rounded-2xl p-4 shadow-2xl text-xs space-y-2 z-30">
                  <h5 className="font-extrabold text-[#00B880] uppercase">Diretriz Operacional</h5>
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-1.5 bg-slate-800/80 hover:bg-slate-700 text-emerald-300 text-xs font-bold rounded-xl flex items-center gap-1.5 transition cursor-pointer border border-[#00B880]/30"
              >
                <Sparkles className="h-3.5 w-3.5 text-[#00B880]" />
              ...
              {showAiAnalysis && (
                <div className="absolute right-0 mt-2 w-72 bg-slate-900 border border-slate-700 rounded-2xl p-4 shadow-2xl text-xs space-y-2 z-30">
                  <div className="flex items-center gap-2 text-[#00B880] font-black uppercase">
            ...
            <button
              ...
              className="bg-[#00B880] hover:bg-[#05C480] text-white px-5 py-2.5 rounded-full font-extrabold text-xs flex items-center gap-2 shadow-lg shadow-[#00B880]/20 cursor-pointer transition"
            >
